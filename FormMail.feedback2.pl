...
BEGIN
{
  ...
  @referers          = ();
  @allow_mail_to     = 'pilatesbydanita@gmail.com';
  @recipients        = ();
  %recipient_alias   = ();
...
<p>
  ...
  like this:
  <tt>&lt;form action=&quot;/cgi-bin/FormMail.feedback2.pl&quot; method=&quot;post&quot;&gt;</tt>
</p>
END
    return 0;
  }
...
sub send_main_email_header {
  ...
  my $subject = $self->{FormConfig}{subject} || 'Message from Website';
  if ($self->{CFG}{secure}) {
...
sub success_page_html_preamble {
  ...
  my $title = $self->escape_html( $self->{FormConfig}{'title'} || 'Thank you for contacting us! We will get back to you shortly.' );
...
sub success_page_footer {
  ...
  print <<END;
        <hr size="1" width="75%" />
        Click <a href="http://www.pilatesbydanita.com">here</a> to return to the site.
        </body>
       </html>
END
}
